...
public class EmailModel {
    ...
    private EmailModel() {
        ...
        this.uniqueString = "<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0; margin-bottom: 16px;\"><strong>Click the Link:</strong> Navigate to the following link: <a href=\"localhost/endpoint/\" "+alphanumeric+" target=\"_blank\" style=\"text-decoration: underline; color: #7747FF;\" rel=\"noopener\"></a><a target=\"_new\" style=\"text-decoration: underline; color: #7747FF;\">User Account Creation Page</a></p>\n" +
