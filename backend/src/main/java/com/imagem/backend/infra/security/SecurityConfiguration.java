    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/ia/accuracy").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/ia/accuracy/all").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/ia/count/sentiment").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/ia/count/review").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/ia/accuracy/month").hasRole("USER")
