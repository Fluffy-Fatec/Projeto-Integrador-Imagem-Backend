    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/graphics/states").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/graphics/review/classifier/**").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/ia/accuracy").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/ia/accuracy/all").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/ia/count/sentiment").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/ia/count/review").hasRole("USER")
                        .requestMatchers(HttpMethod.GET, "/ia/accuracy/month").hasRole("USER")
